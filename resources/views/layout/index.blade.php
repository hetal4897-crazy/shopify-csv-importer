...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
   <head>
      ...
      <!-- jsvectormap css -->
      <link href="{{asset('theme/assets/libs/jsvectormap/jsvectormap.min.css')}}" rel="stylesheet" type="text/css" />
      <!--Swiper slider css-->
      ...
      <link href="{{asset('theme/assets/css/custom.min.css')}}" rel="stylesheet" type="text/css" />
       <link rel="stylesheet" href="//cdn.bootcss.com/toastr.js/latest/css/toastr.min.css">
        <link rel="stylesheet" href="{{asset('theme/assets/1.11.5/css/dataTables.bootstrap5.min.css')}}" />
    <!--datatable responsive css-->
    <link rel="stylesheet" href="{{asset('theme/assets/responsive/2.2.9/css/responsive.bootstrap.min.css')}}" />

    <link rel="stylesheet" href="{{asset('theme/assets/buttons/2.2.2/css/buttons.dataTables.min.css')}}">
   </head>
   <body>
      <!-- Begin page -->
            ...
            <div id="scrollbar">
               <div class="container-fluid">
                  ...
                  <ul class="navbar-nav" id="navbar-nav">
                     ...
                     <li class="nav-item">
                        <a class="nav-link menu-link {{ request()->routeIs('upload') ? 'active' : '' }}" href="{{route('upload')}}">
                        <i class=" ri-file-upload-line"></i> <span data-key="t-widgets">Upload File</span>
                        </a>
                     </li>

                     <li class="nav-item">
                        <a class="nav-link menu-link {{ request()->routeIs('product-list') ? 'active' : '' }}" href="{{route('product-list')}}">
                        <i class="ri-bubble-chart-fill"></i> <span data-key="t-widgets">Product List</span>
                        </a>
                     </li>

                     <li class="nav-item">
                        <a class="nav-link menu-link {{ request()->routeIs('file-list') ? 'active' : '' }}" href="{{route('file-list')}}">
                        <i class="ri-booklet-fill"></i> <span data-key="t-widgets">File History</span>
                        </a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link menu-link {{ request()->routeIs('logs') ? 'active' : '' }}" href="{{route('logs')}}">
      ...
      <!-- Vector map-->
      <script src="{{asset('theme/assets/libs/jsvectormap/jsvectormap.min.js')}}"></script>
      ...
      @yield('footer')
       ...
       <script src="{{asset('theme/assets/1.11.5/js/jquery.dataTables.min.js')}}"></script>
    <script src="{{asset('theme/assets/1.11.5/js/dataTables.bootstrap5.min.js')}}"></script>
    <script src="{{asset('theme/assets/responsive/2.2.9/js/dataTables.responsive.min.js')}}"></script>
    <script src="{{asset('theme/assets/buttons/2.2.2/js/dataTables.buttons.min.js')}}"></script>
    <script src="{{asset('theme/assets/buttons/2.2.2/js/buttons.print.min.js')}}"></script>
    <script src="{{asset('theme/assets/buttons/2.2.2/js/buttons.html5.min.js')}}"></script>
